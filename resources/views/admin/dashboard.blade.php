    ...
    <div class="main-content">
        ...
        <div class="row mt-1">
            <div class="col-12">
                <div class="profile-card">
                    ...
                    <a href="{{ route('admin.profile.edit') }}" class="btn btn-blue">See Details</a>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-1">
            ...
            <div class="col-md-3">
                <div class="card-custom text-center">
                    <div class="dropdown float-end">
                        <button class="btn btn-sm btn-light dropdown-toggle dropdown-toggle-dashboard" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-three-dots-vertical"></i>
                        </button>
            ...
            <div class="col-md-3">
                <div class="card-custom text-center">
                    <div class="dropdown float-end">
                        <button class="btn btn-sm btn-light dropdown-toggle dropdown-toggle-dashboard" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-three-dots-vertical"></i>
                        </button>
            ...
            <div class="col-md-3">
                <div class="card-custom text-center">
                    <div class="dropdown float-end">
                        <button class="btn btn-sm btn-light dropdown-toggle dropdown-toggle-dashboard" type="button" id="dropdownMenuButton4" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-three-dots-vertical"></i>
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton4">
                            <li><a class="dropdown-item" href="?totalUsers_time_frame=month">This Month</a></li>
                            <li><a class="dropdown-item" href="?totalUsers_time_frame=year">This Year</a></li>
                            <li><a class="dropdown-item" href="?totalUsers_time_frame=overall">Overall</a></li>
                        </ul>
                    </div>
            ...
            <div class="col-md-5 container">
                <div class="card card-custom p-4">
                    ...
                    <div class="task-item d-flex justify-content-between align-items-center mb-3" style="background-color: {{ $loop->index % 2 == 0 ? 'rgba(37, 116, 252, 0.893)' : 'rgba(92, 92, 92, 0.818)' }}; border-radius: 15px; padding: 10px;">
                        ...
                        <a href="{{ route('admin.projects.detail', $task->project_id) }}" class="btn btn-light">Details</a>
                    </div>
                    @endforeach
                </div>
            </div>
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: [
                    @foreach ($tasks as $task)
                    {
                        title: '{{ $task->name }}',
                        start: '{{ $task->due_date }}',
                        url: '{{ route('admin.projects.detail', $task->project_id) }}', // Direct link to project detail page
