                            ...
                            <table id="example" class="table table-hover mt-5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-blue" onclick="window.location.href='{{ route('admin.projects.detail', $project->project_id) }}'">Detail</button>
                                            ...
                                            <button type="button" class="btn btn-sm btn-red" onclick="confirmDelete('{{ route('admin.projects.destroy', $project->project_id) }}')">Delete</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editProjectModal').on('show.bs.modal', function (event) {
                ...
                $('#editProjectForm').attr('action', '/admin/projects/' + projectId);
            });
        });
    </script>
